...
Try {
	...
	[string]$appName = 'LanSchool Student'
	[string]$appVersion = '9.1.0.82'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '1/12/2023'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Execute-MSI -Action "Install" -Path "$dirFiles\Student.msi" -AddParameters '/QN ADVANCE_OPTIONS=1 AD_SECURE_MODE=1 LCS=147.153.28.20 FOLLOW_RDP_DESKTOP=1 INSTALL_CHROME_EXTENSION=1 INSTALL_FIREFOX_EXTENSION=1 INSTALL_EDGE_EXTENSION=1'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-MSI -Action "Uninstall" -Path "$dirFiles\Student.msi" -AddParameters '/QN'
	...
	ElseIf ($deploymentType -ieq 'Repair')
	{
		...
		Execute-MSI -Action "Repair" -Path "$dirFiles\Student.msi" -AddParameters '/QN ADVANCE_OPTIONS=1 AD_SECURE_MODE=1 LCS=147.153.28.20 FOLLOW_RDP_DESKTOP=1 INSTALL_CHROME_EXTENSION=1 INSTALL_FIREFOX_EXTENSION=1 INSTALL_EDGE_EXTENSION=1'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBhCIUu7ay8QkJA
# JEmF/pGrY9oDfKfTWzBisZX194dCgKCCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQghkBrcTIIEMqc
# 6kJgIrvQLC5AdDR9Xjc+6hVDdGh7ljAwDQYJKoZIhvcNAQEBBQAEggGAVogDy90t
# 6ttMl5SVt5Ch4WGofY3Vxv+hyN9nRoIAQzV1BGT2SIvRYNbZ2dSpWU16Y470u9tc
# AXGszkdUbv1XfWo+RJHj7a6Yc9Y5QZ9xbCRJDIa5eKTZXsQ/FPmwYZnYT9q+7B8F
# KLUI72NH8Evm9EA0Z/IgOUw4PYqPqNPRgj0+87WXXyIbIbvtmW/Zx15GhVHKHDeA
# JnoTjJDkcLsaDm9mKLcWB5x6MhcDpeeNnCC5EEHzCYA+Tqe2VtFX82wxn4j3g2Vh
# fjqVShLzIoHav5rPGWrqodxYwIyICtzH//eNKEnWW1ZkVPybtMTj49hBRLJN8eok
# t+/s//lqYu/Wwi47+v/9/VSgFGOATBss/36h+03mxCZnPbvFmywbhr+zELLBo0sO
# hCihbMxzmGrCOL+Utez4HffHprCgfw8tjsBv+BLntDXAv9xZWrS4RIeMujDYutH7
# QocIkGm4eIMK/pRyKQ9HmzWO/0X3ORWqOSsA8cgv/EqBBHVqdI9aXGm8oYIDTDCC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzAxMTMy
# MjE3NDRaMD8GCSqGSIb3DQEJBDEyBDDuc88JxdjDO1Q+WYnz0nBhBcoS2FBrDaZ+
# or6RACqwqJb6pKvAVomSFdIU7DKnkFUwDQYJKoZIhvcNAQEBBQAEggIAKRGNtPnz
# lHCVIjXAWAGBotMLpSdnIpaskemIDQypf3rhM0KFnoq7HCORTn/JhcBv4IwcsqX1
# 6v1BlCS4HERzctGUTMOsxcQjZ4FvpOoATwYtw+2bhu1owZ4hMnVuWHHZh2bydoFM
# WiKYpPn6KQR8P342KfbzMqnT7J8oVayFGQnMdGwuZD3f8GqiRJzs1YR29mEl717g
# 67XU1L8w0YgTg6wG24NEryjK3Lem845tkgGoZOu5QnNsZ9h1bvUcaA8vmsHDB9KJ
# B4k4GzPF+CTjItFthaEnVMW49/dy+uAnWLN3P9Pep92eEyKoVu81M58LyS3pWvq0
# dxgq5flrz4VobofjJ62lAVAAfoWCbtS8Hq7D9kjHdrFCmg7YXongecjKDjsPsOBk
# rB1ZVr0PlMLFWlmU6d7kRbmQdwxhwk+fbEhDQLg2GwpZx4I7xnWeFG0BQfqeGIHN
# p1IDlKwigN0ku2z9dxqnVkPLIyOoYas1tdYmKBmfFCT+OsRISoCZT4Y1JBKswXRo
# 1xXnuDimMtwb8QzXFUTFevFebeDHVxx+l6FjXNMR2Et/7Wfi+ynOZ7myKAeLphgt
# hsez5YY8+fjZZhGFu1WxV1OM0DEpHegz2+rokJ32bdd/v4X2EDOMGG3dMD5jFDri
# BUZjurkIAT+5OMY6iAf/dCvDXyNhJlic9xM=
